...
const binData = [
  ...
  { id: 2, fillLevel: 80, location: "Malviya Nagar", lat: 40.758896, lng: -73.98513, lastUpdate: "2023-05-20 11:15" },
...
export default function BinStatusPage() {
  ...
  // Ensuring that the map is only loaded on the client side
  useEffect(() => {
  ...
  // Helper function to get the bin color based on its fill level
                  ...
                  <MapContainer center={[40.73061, -73.935242]} zoom={12} style={{ height: "100%", width: "100%" }}>
                    ...
                    {binData.map((bin) => (
                      <Marker
                        ...
                        icon={
                          new L.Icon({
                            iconUrl: `https://raw.githubusercontent.com/pointhi/leaflet-color-markers/master/img/marker-icon-2x-${getBinColor(
                              bin.fillLevel
                            )}.png`,
